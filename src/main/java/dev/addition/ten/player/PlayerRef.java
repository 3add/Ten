...
public class PlayerRef {
    ...
    /**
     * Converts this PlayerRef to a Bukkit Player object if the player is online. ({@link PlayerRef#isOnline()})
     * @return The Bukkit Player object, or null if the player is offline.
     */
    public @UnknownNullability Player toBukkitPlayer() {
    ...
    public boolean equals(Object o) {
        if (!(o instanceof PlayerRef otherPlayer)) return false;
        return otherPlayer.getUUID().equals(this.getUUID());
    }
